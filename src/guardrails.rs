...
mod tests {
    ...
    fn test_check_repeated_failures() {
        ...
        let fail1 = ToolResult::err("test", "test");
        let fail2 = ToolResult::err("test", "test");
        let fail3 = ToolResult::err("test", "test");
        let fail4 = ToolResult::err("test", "test");
        let success1 = ToolResult::ok("test", "test");
