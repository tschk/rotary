...
pub fn register_tools(registry: &mut ToolRegistry) {
    registry.register(ToolDefinition {
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_call(args)))),
    ...
    registry.register(ToolDefinition {
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_click(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        name: "cu_type".into(),
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_type(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        name: "cu_hotkey".into(),
        ...
        parameters_json:
            r#"{"type":"object","properties":{"keys":{"type":"string"}},"required":["keys"]}"#
                .into(),
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_hotkey(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        name: "cu_scroll".into(),
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_scroll(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        name: "cu_window".into(),
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_window(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        name: "cu_app".into(),
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_app(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        name: "cu_list".into(),
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_list(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        name: "cu_open".into(),
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_open(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        ...
        execute: ToolExecutor::Boxed(Box::new(|_ctx, args| Box::pin(exec_clipboard(args)))),
        effect: ToolEffect::Process,
    });
    registry.register(ToolDefinition {
        name: "cu_doctor".into(),
