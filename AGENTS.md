...
- Interactive Ask: prefer `AsyncApprover` / `ChannelAsyncApprover` (pi beforeToolCall is async); sync `ChannelApprover` also works.
- ComputerUse defaults to workspace_write; hosts opt into full_access.
- Keep MPL-2.0.
